            ...
            <div class="upper">
                <div class="wrp">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 686 548" enable-background="new 0 0 686 548" xml:space="preserve">
                        <g id="bg">
                            <g>
...
597.4,204.6 653,170.5 583.1,223.1 588.5,204.6 560.9,228 562.4,212.3 		" />
                                ...
                                <ellipse transform="matrix(0.743 -0.6692 0.6692 0.743 42.794 307.6485)" fill-rule="evenodd"
                                    clip-rule="evenodd" fill="#ee3333" cx="422" cy="98.1" rx="71.3" ry="57.8" />
...
c1.6,3.6,2.8,7.2,3.8,10.6H351.4c-2-3.5-3.8-7-5.4-10.6C326.4,349,354.2,311.9,408.2,311.9z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" fill="#A7C0DC"
...
c-5.4,10.7-18.5,15-29.2,9.5c-0.3-0.2-109.4-65.6-87.1-104.1C177.2,225.2,355.6,313.1,356.1,313.2z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" fill="#5D7A93"
...
C241.7,189,243.5,155.3,260.4,136.2z" />
                            ...
                            <g id="hair2">
                                <path fill-rule="evenodd" clip-rule="evenodd" fill="#924E48"
...
233.6,383.1 164.5,351.3 252.9,402.5 244,381.8 279.2,405.2 275.3,387.1 	" />
                        ...
                        <g id="papers">
                            <path fill-rule="evenodd" clip-rule="evenodd" fill="#D6F3ED"
...
h-19.5c-1.8,0-3.2-1.5-3.2-3.2v0C207.4,428.6,208.9,427.2,210.7,427.2z" />
    ...
    <div class="mobile-desktop xl:grid xl:grid-cols-3 pb-4">
...
<script>
    function fadeOutNotificationsContainer() {
